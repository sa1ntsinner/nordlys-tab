# Privacy Policy for AetherTab

**Effective Date:** August 16, 2026
**Last Updated:** August 16, 2026
**Version:** 2.1.0

AetherTab ("the extension", "we", or "our") is designed with a strict **Privacy-by-Architecture** principle. AetherTab is a client-side, offline-capable New Tab override extension.
...
- **Zero Analytics or Trackers:** AetherTab does not include Google Analytics, Mixpanel, Sentry, PostHog, or any tracking telemetry.
...
In accordance with the Principle of Least Privilege, AetherTab requests only the minimum necessary permissions:
...
- **Narrow host permissions**: Only the search-suggestion endpoints listed in section 3 plus `images.weserv.nl`. AetherTab cannot read, alter, or transmit data from web pages you visit.
- **No `tabs` History Access**: AetherTab does not inspect your browsing history, active tabs, or open URLs.

---

## 5. Content Security Policy (CSP)

AetherTab enforces the strict Manifest V3 Content Security Policy:
...
AetherTab is 100% transparent and open source.
- **Repository:** https://github.com/sa1ntsinner/aethertab
- **License:** MIT License
